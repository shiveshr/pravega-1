...
public class HistoryTimeSeriesRecordSerializer extends
    ...
    private void read00(RevisionDataInput revisionDataInput, HistoryTimeSeriesRecord.HistoryTimeSeriesRecordBuilder builder) throws IOException {
        builder.epoch(revisionDataInput.readInt())
                ...
                .segmentsSealed(revisionDataInput.readCollection(SegmentRecord.SERIALIZER::deserialize, ArrayList::new))
                .segmentsCreated(revisionDataInput.readCollection(SegmentRecord.SERIALIZER::deserialize, ArrayList::new))
    ...
    private void write00(HistoryTimeSeriesRecord history, RevisionDataOutput revisionDataOutput) throws IOException {
        ...
        revisionDataOutput.writeCollection(history.getSegmentsSealed(), SegmentRecord.SERIALIZER::serialize);
        revisionDataOutput.writeCollection(history.getSegmentsCreated(), SegmentRecord.SERIALIZER::serialize);
